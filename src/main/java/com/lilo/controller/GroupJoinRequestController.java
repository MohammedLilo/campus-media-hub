...
public class GroupJoinRequestController {
	...
	@GetMapping("/group-join-request")
	GroupJoinRequestsDTO getGroupJoinRequests(@RequestParam("groupId") int groupId,
			@RequestParam(name = "page", defaultValue = "0") int pageNumber,
			@RequestParam(name = "pageSize", defaultValue = "15") int pageSize) {
		Page<GroupJoinRequest> page = groupJoinRequestService.findPendingRequestsByGroupId(groupId, pageNumber,
