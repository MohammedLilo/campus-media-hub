...
CREATE TABLE `group_join_request` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_GROUPJOINREQUEST_USER` (`user_id`),
  KEY `FK_GROUPJOINREQUEST_GROUP` (`group_id`),
  CONSTRAINT `FK_GROUPJOINREQUEST_GROUP` FOREIGN KEY (`group_id`) REFERENCES `group_table` (`id`),
  CONSTRAINT `FK_GROUPJOINREQUEST_USER` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
...
LOCK TABLES `group_join_request` WRITE;
/*!40000 ALTER TABLE `group_join_request` DISABLE KEYS */;
/*!40000 ALTER TABLE `group_join_request` ENABLE KEYS */;
UNLOCK TABLES;
