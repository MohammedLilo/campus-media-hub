...
CREATE TABLE `friendship` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_FRIENDSHIP_USER_SENDER` (`user_id`),
  KEY `FK_FRIENDSHIP_USER_RECEIVER` (`friend_id`),
  CONSTRAINT `FK_FRIENDSHIP_USER_RECEIVER` FOREIGN KEY (`friend_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FK_FRIENDSHIP_USER_SENDER` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
