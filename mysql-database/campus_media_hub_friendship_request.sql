...
CREATE TABLE `friendship_request` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_FRIENDSHIPREQUESTSENDER_USER` (`sender_id`),
  KEY `FK_FRIENDSHIPREQUESTRECIPIENT_USER` (`recipient_id`),
  CONSTRAINT `FK_FRIENDSHIPREQUESTRECIPIENT_USER` FOREIGN KEY (`recipient_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FK_FRIENDSHIPREQUESTSENDER_USER` FOREIGN KEY (`sender_id`) REFERENCES `user` (`id`)
