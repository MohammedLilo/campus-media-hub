...
CREATE TABLE `block` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_BLOCK_USER_BLOCKER` (`user_id`),
  KEY `FK_BLOCK_USER_BLOCKED` (`blocked_user_id`),
  CONSTRAINT `FK_BLOCK_USER_BLOCKED` FOREIGN KEY (`blocked_user_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FK_BLOCK_USER_BLOCKER` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
