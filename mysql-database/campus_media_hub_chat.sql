...
CREATE TABLE `chat` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_CHAT_USER_SENDER` (`sender_id`),
  KEY `FK_CHAT_USER_RECIPIENT` (`recipient_id`),
  CONSTRAINT `FK_CHAT_USER_RECIPIENT` FOREIGN KEY (`recipient_id`) REFERENCES `user` (`id`),
  CONSTRAINT `FK_CHAT_USER_SENDER` FOREIGN KEY (`sender_id`) REFERENCES `user` (`id`)
